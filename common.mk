...
# กราฟิก: ต้องอยู่ที่นี่ ไม่ใช่ใน proj_cm55/Makefile
#
# พอเปิด GFXSS ใน design.modus แล้ว cycfg_peripherals.h จะ #include "cy_graphics.h"
# และไฟล์นั้นถูกคอมไพล์โดย "ทั้งสามโปรเจกต์" (cm33_s, cm33_ns, cm55)
# ถ้าใส่ component เฉพาะ cm55 อีกสองตัวจะพังด้วย fatal error: cy_graphics.h not found
COMPONENTS+=GFXSS
