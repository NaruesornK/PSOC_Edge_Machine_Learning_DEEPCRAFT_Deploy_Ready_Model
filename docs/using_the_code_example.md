...
The following example clones the "[mtb-example-psoc-edge-ml-deepcraft-deploy-ready-model](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-deploy-ready-model)" application with the desired name "DeployReadyModel" configured for the *KIT_PSE84_AI* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_AI --app-id mtb-example-psoc-edge-ml-deepcraft-deploy-ready-model --user-app-name DeployReadyModel --target-dir "C:/mtb_projects"
   ```
